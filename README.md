...
| Proxmox VE | Cloud | [`cloud/proxmox-ve`](cloud/proxmox-ve) | [0.1.16-lab](https://github.com/tgessendorfer/hpe-morpheus-ent-plugins/releases/tag/proxmox-ve-v0.1.16-lab) | Lab build of HPE's community Proxmox VE plugin, with Proxmox VE 9 support. Verified on Morpheus 9.0.1 with Proxmox VE 9.2.10. Community code without support. |
